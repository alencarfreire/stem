...
const i18n = {
  en: {
    ...
    del: "delete() → halt(204)",
    emptyBranch: "branch taken, no leaf → 404",
    onIntMiss: "onInt() miss — branch already taken → 404",
  ...
  pt: {
    ...
    del: "delete() → halt(204)",
    emptyBranch: "ramo tomado, sem folha → 404",
    onIntMiss: "onInt() não casa — ramo já tomado → 404",
